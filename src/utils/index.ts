...
export const getTime = (timestamp: number | undefined): string | void => {
  if (timestamp) {
...
export const getPressureDescription = (pressure: number | undefined): string | void => {
  if(pressure) {
    let description = ''
...
export const getHumidityDescription = (humidity: number | undefined): string | void => {
  if (humidity) {
...
export const getVisibilityValueInKm = (value: number | undefined): number | void => {
  if (value) return Math.floor(value / 1000)
}

export const getVisibilityDescription = (value: number | undefined): string | void => {
  if (value) {
    switch(true) {
      case (value <= 50):
...
export const getWindSpeedInKm = (speed: number | undefined): string | void => {
  if (speed) return (speed * 3.6).toFixed(1)
}

export const getWindDirection = (degrees: number | undefined): string | void => {
  if (degrees) {
